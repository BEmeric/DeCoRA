...
# ------------------------------------------------- SAVING --------------------------------------------------
    ...
    def save_analysis(self):
        ...
        #report_name = globalvar.OUTPUT_DIRECTORY.split("/")[0] # Pathway on local computer
        ...
        with open(globalvar.INPUT_DIRECTORY+"/expMeta.dat") as data_file: # Pathway for expMeta.dat file on local computer
            ...
            if not re.search(sn2, report_name):
                print "No good report name or report name incomplete in the analysis file header, may be you are not on pgm server, please check expMeta.dat file existing .."
    ...
    def save_hotspot_analysis(self):
        ...
        with open(globalvar.INPUT_DIRECTORY+"/expMeta.dat") as data_file: # Pathway for expMeta.dat file on local computer
            ...
            sn2=re.findall("SN2-\d+", RunName)[0]
            if not re.search(sn2, report_name):
                print "No good report name or report name incomplete in the hotspot analysis file header, may be you are not on pgm server, please check expMeta.dat file existing .."
                report_name = lignes[16].split("=")[1]
    ...
    def save_report(self):
        ...
        with open(globalvar.INPUT_DIRECTORY+"/expMeta.dat") as data_file: # Pathway for expMeta.dat file on local computer
            ...
            sn2=re.findall("SN2-\d+", RunName)[0]
            if not re.search(sn2, report_name):
                print "No good report name or report name incomplete in the report file header, may be you are not on pgm server, please check expMeta.dat file existing .."
                report_name = lignes[16].split("=")[1]
