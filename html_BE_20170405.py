...
def write_html():
    ...
    # line modif
    #OUT = open(globalvar.OUTPUT_DIRECTORY+"/decora_block.html", "w")
    ...
    OUT.write("<a class=\"btn\" href=\"No_covered_exons_report.txt\"> No_covered_exons_report </a> \n")
    OUT.write("<div class=\"footer\"> \n")
    OUT.write("\t<a href=/plugins/DeCoRA/data/terms-of-use.txt>Terms of Use</a> \n")
    OUT.write("\t<br/>Copyright &copy; 2017<a> Plateforme NGS IBP</a> \n")
    OUT.write("</div> \n")
...
def write_html_line(OUT,dict_sample):
    for barcode in dict_sample:
        ...
        # line modif
        OUT.write("\t\t<td><a class=\"btn\" href=\""+sample+"_"+barcode+"_analysis.txt\">"+sample+"_"+barcode+"_analysis.txt</a></td> \n")
        if (not globalvar.HOTSPOT_FILE == ""):
            ...
            # line modif
            OUT.write("\t\t<td><a class=\"btn\" href=\""+sample+"_"+barcode+"_analysis_hotspot.txt\">"+sample+"_"+barcode+"_analysis_hotspot.txt</a></td> \n")
        else:
            OUT.write("\t\t<td></td> \n")
        if (globalvar.BED2WIG):
            #OUT.write("\t\t<td><a class=\"btn\" href=\""+barcode+".wig\">"+barcode+".wig</a></td> \n")
            # line modif
            OUT.write("\t\t<td><a class=\"btn\" href=\""+sample+"_"+barcode+".wig\">"+sample+"_"+barcode+".wig</a></td> \n")
        else:
            OUT.write("\t\t<td></td> \n")
        #OUT.write("\t\t<td><a class=\"btn\" href=\"report_"+barcode+".txt\">report_"+barcode+".txt</a></td> \n")
        # line modif
        OUT.write("\t\t<td><a class=\"btn\" href=\""+sample+"_"+barcode+"_report.txt\">"+sample+"_"+barcode+"_report.txt</a></td> \n")
        OUT.write("\t\t</tr> \n")
        OUT.write("\n")
...
def read_json():
    ...
    if os.path.isfile(globalvar.OUTPUT_DIRECTORY+"/barcodes.json"):
        ...
        print "no barcodes.json file for reading"
    return dict_sample