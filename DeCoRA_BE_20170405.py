...
def CNV_hypothesis():
    ...
    for filename in filenames[:-1]:
        ...
        elif ("IonXpress_" in file_sample):
...
def analysis(path): 
    ...
    elif ("IonXpress_" in filename):
        sample = filename.split('_')[0]+"_"+filename.split('_')[1]
    elif ("_S1" in filename):
        sample = filename.split('_')[0]
    else:
        print "No barcode name, may be you are not on pgm server or NextSeq server, please check it!"
        sample = "None"
